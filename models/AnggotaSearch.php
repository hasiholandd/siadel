...
class AnggotaSearch extends Anggota
{
    ...
    public function rules()
    {
        return [
            [['id'], 'integer'],
            [['nama', 'email', 'tempat', 'tanggal_lahir', 'agama', 'pekerjaan', 'alamat', 'angkatan', 'no_hp', 'updated_at', 'created_at', 'prodi', 'lulusan'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'nama', $this->nama])
            ...
            ->andFilterWhere(['like', 'lulusan', $this->lulusan]);
